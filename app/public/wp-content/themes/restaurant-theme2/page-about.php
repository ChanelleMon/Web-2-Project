  ...
  <body>
	    			...
	    			<div class="row no-gutters">
	    				...
	    				<div class="col-md-4 d-flex ftco-animate">
	    					...
	    					<div class="text">
	    						...
	    						<p>Suite 721 Naples, Italy 10016</p>
	    					</div>
	    				</div>
	    				<div class="col-md-4 d-flex ftco-animate">
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div class="heading-section ftco-animate ">
          <h2 class="mb-4">Welcome to <span class="flaticon-pizza">Squisito</span> Restaurant</h2>
        </div>
        <div>
      ...
      <div class="container">
        ...
        <div class="row">
        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				<div class="img mb-4" style="background-image: url(<?php echo get_theme_file_uri('images/person_1.jpg'); ?>);"></div>
        	...
        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				<div class="img mb-4" style="background-image: url(<?php echo get_theme_file_uri('images/person_2.jpg'); ?>);"></div>
      				<div class="info text-center">
        	...
        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				<div class="img mb-4" style="background-image: url(<?php echo get_theme_file_uri('images/person_3.jpg'); ?>);"></div>
      				<div class="info text-center">
        	...
        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				<div class="img mb-4" style="background-image: url(<?php echo get_theme_file_uri('images/person_4.jpg'); ?>);"></div>
      				<div class="info text-center">
